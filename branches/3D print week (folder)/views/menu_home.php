	...
	<div data-role="content">
		<div id="container">
			...
			<ul data-role="listview" id="listview_print" class="shadowBox" data-inset="true">
				...
				<li id="upload_li"><a href="#threeD_print_week" data-rel="popup" data-transition="pop">
					<h2>{upload}</h2></a>
					</li>
			</ul>
			<ul data-role="listview" id="listview_library" class="shadowBox" data-inset="true">
				<li style="display: {library_visible};">
					<a href="#threeD_print_week" data-rel="popup" data-transition="pop"><h2>{my_library}</h2></a>
				</li>
				<li>
