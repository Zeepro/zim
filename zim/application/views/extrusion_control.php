		...
		<div id="container">
			<div data-role="collapsible" data-collapsed="true" style="align: center;" id="temper_collaspible">
				...
				<div class="widget_heatbed" style="display: none;">
					...
					<div style="width:40px;float:left;margin-right:10px;">
						<input type="text" data-clear-btn="false" name="temper_bed_current" id="temper_bed_current" value="0" disabled>
					</div>
					<div style="width:60px;float:left;margin-right:10px;">
						<input type="number" style="text-align:right;" data-clear-btn="false" name="temper_bed" id="temper_bed" value="90">
					</div>
					<a href="#" data-role="button" data-icon="check" data-iconpos="left" data-inline="true" onclick="heat('b');">Set</a>
					<a href="#" data-role="button" data-icon="delete" data-iconpos="left" data-inline="true" onclick="heat('b', 0);">Stop</a>
					<a href="#" data-role="button" data-icon="refresh" data-iconpos="left" data-inline="true" onclick="refreshCheckTemper();">Refresh</a>
				</div>
			</div>
