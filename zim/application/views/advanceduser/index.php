		...
		<div id="container">
			<div data-role="collapsible" data-collapsed="true"
				...
				<div data-role="collapsible" data-collapsed="true"
					...
					<table style="text-align: center; margin: 0 auto;">
						<tr>
							<td><a href="#" data-role="button" data-icon="grid"
								data-iconpos="left" data-inline="true"
								onclick="level('xmin_ymax');">Move</a></td>
							<td></td>
							<td><a href="#" data-role="button" data-icon="grid"
								data-iconpos="left" data-inline="true"
								onclick="level('xmax_ymax');">Move</a></td>
						</tr>
						<tr>
							<td></td>
							<td><a href="#" data-role="button" data-icon="grid"
								data-iconpos="left" data-inline="true"
								onclick="level('center');">Move</a></td>
							<td></td>
						</tr>
						<tr>
							<td><a href="#" data-role="button" data-icon="grid"
								data-iconpos="left" data-inline="true"
								onclick="level('xmin_ymin');">Move</a></td>
							<td></td>
							<td><a href="#" data-role="button" data-icon="grid"
								data-iconpos="left" data-inline="true"
								onclick="level('xmax_ymin');">Move</a></td>
						</tr>
					</table>
				</div>
			</div>
