...
/* 				div.ui-slider-switch {width: 150px;} */
			...
			<div data-role="collapsible">
				...
				<div data-role="collapsible" data-collapsed="false" data-theme="d" data-content-theme="b">
					...
					<div class="ui-grid-a">
						...
						<div class="ui-block-b"><div class="ui-bar ui-bar-f">
							<input type="number" data-clear-btn="false" name="layer_height" id="layer_height" value="{layer_height_value}">
						</div></div>
						<div class="ui-block-a"><div class="ui-bar ui-bar-f">
			...
			<div data-role="collapsible">
				...
				<div data-role="collapsible" data-collapsed="false" data-theme="d" data-content-theme="b">
					...
					<div class="ui-grid-a">
						...
						<div class="ui-block-b"><div class="ui-bar ui-bar-f">
							<input type="text" data-clear-btn="false" name="small_perimeter_speed" id="small_perimeter_speed" value="{small_perimeter_speed_value}">
						</div></div>
						<div class="ui-block-a"><div class="ui-bar ui-bar-f">
							<label for="external_perimeter_speed">{external_perimeter_speed}</label>
						</div></div>
						<div class="ui-block-b"><div class="ui-bar ui-bar-f">
							<input type="text" data-clear-btn="false" name="external_perimeter_speed" id="external_perimeter_speed" value="{external_perimeter_speed_value}">
						</div></div>
						<div class="ui-block-a"><div class="ui-bar ui-bar-f">
						...
						<div class="ui-block-b"><div class="ui-bar ui-bar-f">
							<input type="text" data-clear-btn="false" name="solid_infill_speed" id="solid_infill_speed" value="{solid_infill_speed_value}">
						</div></div>
						<div class="ui-block-a"><div class="ui-bar ui-bar-f">
							<label for="top_solid_infill_speed">{top_solid_infill_speed}</label>
						</div></div>
						<div class="ui-block-b"><div class="ui-bar ui-bar-f">
							<input type="text" data-clear-btn="false" name="top_solid_infill_speed" id="top_solid_infill_speed" value="{top_solid_infill_speed_value}">
						</div></div>
						<div class="ui-block-a"><div class="ui-bar ui-bar-f">
				...
				<div data-role="collapsible" data-collapsed="false" data-theme="d" data-content-theme="b">
					...
					<div class="ui-grid-a">
						...
						<div class="ui-block-b"><div class="ui-bar ui-bar-f">
							<input type="text" data-clear-btn="false" name="first_layer_speed" id="first_layer_speed" value="{first_layer_speed_value}">
						</div></div>
					</div>
				</div>
			</div> <!-- speed -->
			...
			<div data-role="collapsible">
				...
				<div data-role="collapsible" data-collapsed="false" data-theme="d" data-content-theme="b">
					...
					<div class="ui-grid-a">
						...
						<div class="ui-block-b"><div class="ui-bar ui-bar-f">
							<input type="text" data-clear-btn="false" name="extrusion_width" id="extrusion_width" value="{extrusion_width_value}">
						</div></div>
						<div class="ui-block-a"><div class="ui-bar ui-bar-f">
							<label for="first_layer_extrusion_width">{first_layer_extrusion_width}</label>
						</div></div>
						<div class="ui-block-b"><div class="ui-bar ui-bar-f">
							<input type="text" data-clear-btn="false" name="first_layer_extrusion_width" id="first_layer_extrusion_width" value="{first_layer_extrusion_width_value}">
						</div></div>
						<div class="ui-block-a"><div class="ui-bar ui-bar-f">
							<label for="perimeter_extrusion_width">{perimeter_extrusion_width}</label>
						</div></div>
						<div class="ui-block-b"><div class="ui-bar ui-bar-f">
							<input type="text" data-clear-btn="false" name="perimeter_extrusion_width" id="perimeter_extrusion_width" value="{perimeter_extrusion_width_value}">
						</div></div>
						<div class="ui-block-a"><div class="ui-bar ui-bar-f">
							<label for="infill_extrusion_width">{infill_extrusion_width}</label>
						</div></div>
						<div class="ui-block-b"><div class="ui-bar ui-bar-f">
							<input type="text" data-clear-btn="false" name="infill_extrusion_width" id="infill_extrusion_width" value="{infill_extrusion_width_value}">
						</div></div>
						<div class="ui-block-a"><div class="ui-bar ui-bar-f">
							<label for="solid_infill_extrusion_width">{solid_infill_extrusion_width}</label>
						</div></div>
						<div class="ui-block-b"><div class="ui-bar ui-bar-f">
							<input type="text" data-clear-btn="false" name="solid_infill_extrusion_width" id="solid_infill_extrusion_width" value="{solid_infill_extrusion_width_value}">
						</div></div>
						<div class="ui-block-a"><div class="ui-bar ui-bar-f">
							<label for="top_infill_extrusion_width">{top_infill_extrusion_width}</label>
						</div></div>
						<div class="ui-block-b"><div class="ui-bar ui-bar-f">
							<input type="text" data-clear-btn="false" name="top_infill_extrusion_width" id="top_infill_extrusion_width" value="{top_infill_extrusion_width_value}">
						</div></div>
						<div class="ui-block-a"><div class="ui-bar ui-bar-f">
							<label for="support_material_extrusion_width">{support_material_extrusion_width}</label>
						</div></div>
						<div class="ui-block-b"><div class="ui-bar ui-bar-f">
							<input type="text" data-clear-btn="false" name="support_material_extrusion_width" id="support_material_extrusion_width" value="{support_material_extrusion_width_value}">
						</div></div>
					</div>
				</div>
				<div data-role="collapsible" data-collapsed="false" data-theme="d" data-content-theme="b">
