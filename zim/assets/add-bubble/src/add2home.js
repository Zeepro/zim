...
var nav = navigator,
	...
	options = {
		...
		lifespan: 5000,				// 20 seconds before it is automatically destroyed
		bottomOffset: 14,			// Distance of the balloon from bottom
		expire: 8,					// Minutes to wait before showing the popup again (0 = always displayed)
	...
	intl = {
		en_us: 'Install this site on your %device: tap %icon and then <strong>Add to Home Screen</strong>.',
